    ...
    <div className="flex flex-col h-full bg-[#f6f8f7] pb-24">
      ...
      <main className="p-4 space-y-6 overflow-y-auto no-scrollbar">
        <section className="bg-white p-6 rounded-3xl border border-gray-50 shadow-sm space-y-4">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-bold text-gray-400 ml-1">Preço de Venda Sugerido (R$/kg)</label>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold px-1">Ícone e Categoria</h2>
