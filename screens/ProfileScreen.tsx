...
const ProfileScreen: React.FC<ProfileScreenProps> = ({ navigate, onLogout, userRole, userName }) => {
  const getRoleLabel = () => {
    switch (userRole) {
