...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ navigate, userName, userLogo }) => {
  return (
    <div className="flex flex-col h-full bg-[#f6f8f7]">
      {/* Header */}
      <header className="flex items-center justify-between p-5 pb-2 sticky top-0 bg-[#f6f8f7]/95 backdrop-blur-sm z-20">
      ...
      {/* Quick Actions */}
      <section className="px-5 flex-1 overflow-y-auto no-scrollbar pb-24">
      ...
      {/* Bottom Nav */}
      <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto border-t border-gray-100 bg-white p-4 pb-6 z-30 flex justify-between">
